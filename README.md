...
The header mark animates once on load: the tile starts in its notch and comes off the
block. It is CSS, generated by `brand/build-motion.py` from the mark's own geometry,
and it is disabled for a reader who has asked for reduced motion.
